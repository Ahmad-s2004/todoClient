...
const Category = () => {
  ...
  const fetchTasks = async () => {
    ...
    try {
      ...
      if (taskData.length === 0) setNoTasksFound(true);
          ...
          <div className="task-details">
            ...
            <p className="mb-2">
              {selectedTask.favourite ? (
                <>
                  <span className="fw-bold">Favourite: </span>{' '}
                  {selectedTask.favourite ? 'Yes' : 'No'}
                </>
              ) : null}
            </p>
            <p className="mb-2">
            ...
            <p className="mb-2">
              ...
              <span
                className={`badge ${
                  taskCompletion[selectedTask._id] ? 'bg-success' : 'bg-secondary'
                }`}
              >
